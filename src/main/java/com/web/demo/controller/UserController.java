...
public class UserController {
	...
	public String signup(@Valid UserForm userForm, BindingResult bindingResult, 
		...
		// 1. 토큰 2개 발급(엑세스는 7일짜리, 리프레시 30일짜리)
...
//		String accessToken  = this.tokenProvider.reverseGenerateToken(snsUser, Duration.ofDays(7));
		...
		// 3. 토큰을 클라이언트에게 전달 => 쿠키 설정, 쿠키의 만료시간은 ㅋ토큰의 만료시간과 동일하게 구성
		...
		// 4.자동로그인을 미지원 하므로, 로그인 화면으로 자동 리다이렉트 처리
	...
	// 리플레시 토큰을 이용하여 엑세스 토큰 재발행 -> 쿠키저장 -> 홈피이동
